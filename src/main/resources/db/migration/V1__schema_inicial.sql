...
CREATE TABLE dbo.roles (
    ...
    CONSTRAINT FK_roles_estados FOREIGN KEY (estado_id) REFERENCES dbo.estados(id)
);
...
CREATE TABLE dbo.usuarios (
    ...
    CONSTRAINT FK_usuarios_estados FOREIGN KEY (estado_id) REFERENCES dbo.estados(id)
);
...
CREATE TABLE dbo.categorias (
    ...
    CONSTRAINT FK_categorias_estados FOREIGN KEY (estado_id) REFERENCES dbo.estados(id)
);
...
CREATE TABLE dbo.convocatoria_categoria (
    ...
    CONSTRAINT FK_convocatoria_categoria_estados FOREIGN KEY (estado_id) REFERENCES dbo.estados(id)
);
